  ...
  return (
    ...
    <div className="gift-options">
      <div className="gift-option">
        <img src="/assets/images/drone.webp" alt="Tech Gadgets" width="250" height="200" />
        <h3>Tech Gadgets</h3>
        <p>Latest smartphones, laptops, and smart home devices</p>
        <button className="purchase-btn">Explore Tech Gifts</button>
      </div>
      <div className="gift-option">
        <img src="/assets/images/deco3.webp" alt="Home Decor" width="250" height="200" />
        <h3>Home Decor</h3>
        <p>Stylish furniture, art pieces, and decorative items</p>
        <button className="purchase-btn">Explore Home Gifts</button>
      </div>
      <div className="gift-option">
        <img src="/assets/images/fashion.webp" alt="Fashion &amp; Accessories" width="250" height="200" />
      ...
      <div className="gift-option">
        <img src="/assets/images/wedding.webp" alt="Experiences" width="250" height="200" />
        <h3>Experiences</h3>
